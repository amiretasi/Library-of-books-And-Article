...
export const booksData: Book[] = [
    { id: 135, title: 'هنر همیشه بر حق بودن', author: 'آرتور شوپنهاور', originalPubDate: '۱۸۶۴', readYear: '1404/08/25', genre: 'فلسفه', translator: 'علی عبداللهی', nationality: 'آلمان' },
    { id: 134, title: 'زوال کلنل', author: 'محمود دولت آبادی', originalPubDate: '۱۳۸۸', readYear: '1404/08/24', genre: 'رمان', translator: 'تألیفی', nationality: 'ایران' },
    { id: 133, title: 'گدا', author: 'غلامحسین ساعدی', originalPubDate: '۱۳۴۳', readYear: '1404/08/23', genre: 'داستان کوتاه', translator: 'تألیفی', nationality: 'ایران' },
    { id: 132, title: 'گدا', author: 'غلامحسین ساعدی', originalPubDate: '۱۳۴۳', readYear: '1404/08/23', genre: 'داستان کوتاه', translator: 'تألیفی', nationality: 'ایران' },
